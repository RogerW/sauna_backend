SELECT
	...
	"saunas"."name" AS name, 
	"saunas"."logotype_file_name" AS logotype_file_name,
  "saunas"."logotype_content_type" AS logotype_content_type,
  "saunas"."logotype_file_size" AS logotype_file_size,
  "saunas"."logotype_updated_at" AS logotype_updated_at,
