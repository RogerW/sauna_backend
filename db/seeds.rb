...
city = City.create(country:country, name:"Orenburg")
address = Address.create(street:"Test", house:"1", city:city)
...
Billing.create(cost_cents: 100000, start_time: 0, end_time: 6, sauna: sauna)
Billing.create(cost_cents: 200000, start_time: 6, end_time: 22, sauna: sauna)
Billing.create(cost_cents: 150000, start_time: 22, end_time: 24, sauna: sauna)
