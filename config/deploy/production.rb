...
set :linked_files, %w[config/database.yml config/secrets.yml config/puma.rb config/initializers/cors.rb config/initializers/devise.rb config/environments/production.rb]
