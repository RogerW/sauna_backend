#! /bin/sh
PUMA_CONFIG_FILE=/usr/local/cityprice/shared/config/puma.rb
PUMA_PID_FILE=/usr/local/cityprice/shared/tmp/pids/puma.pid
PUMA_SOCKET=/usr/local/cityprice/shared/tmp/socket/puma.sock
